...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!array_filter($errors)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO petugas (nama_petugas, username, password, role) VALUES (?, ?, ?, ?)");
        $stmt->execute([$nama_petugas, $username, $hashed_password, $role]);
...
<body>
    ...
    <div id="main">
        ...
        <form method="POST" action="" onsubmit="return validateForm()">
            <input type="text" id="nama_petugas" name="nama_petugas" placeholder="Nama Petugas" value="<?= htmlspecialchars($_POST['nama_petugas'] ?? '') ?>" required>
